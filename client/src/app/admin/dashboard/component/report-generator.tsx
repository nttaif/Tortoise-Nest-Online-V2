...
import { CalendarIcon, Download, FileSpreadsheet, FileText, FileType, Loader2 } from 'lucide-react';
...
export function ReportGenerator() {
  ...
  const handleGenerateReport = async () => {
    ...
    const interval = setInterval(() => {
      setProgress((prev) => {
        if (prev >= 90) {
          return 90; // Cap at 90% until data is actually ready
        }
        return prev + 5;
      });
    }, 100);
    ...
    try {
      ...
      clearInterval(interval);
      setError("Có lỗi xảy ra khi tạo báo cáo. Vui lòng thử lại sau.");
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Tạo và tải xuống báo cáo theo loại và khoảng thời gian
        </CardDescription>
      </CardHeader>
      <CardContent>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    <p>
                      Tính năng báo cáo định kỳ cho phép bạn lên lịch tự động tạo và gửi báo cáo qua email.
